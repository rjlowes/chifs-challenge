...
exports.default = function () {
    (0, _email.injectEmailLink)($('#email-link'));
};

},{"../util/email":6}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.finalise = exports.init = undefined;
...
var initMenuButton = function initMenuButton() {
    ...
    var button = $('#main-menu-open');
    var point1 = button.find('#menu-point1');
    var point3 = button.find('#menu-point3');
    var point7 = button.find('#menu-point7');
    var point9 = button.find('#menu-point9');

    button.hover(function () {
        _gsap.TweenMax.to(point1, speed, { attr: { x: 6, y: 2, height: 4 } });
        _gsap.TweenMax.to(point3, speed, { attr: { x: 8, y: 6, width: 4 } });
        _gsap.TweenMax.to(point7, speed, { attr: { x: 2, y: 6, width: 4 } });
        _gsap.TweenMax.to(point9, speed, { attr: { x: 6, y: 8, height: 4 } });
    }, function () {
        _gsap.TweenMax.to(point1, speed, { attr: { x: 0, y: 0, height: 2 } });
        _gsap.TweenMax.to(point3, speed, { attr: { x: 12, y: 0, width: 2 } });
        _gsap.TweenMax.to(point7, speed, { attr: { x: 0, y: 12, width: 2 } });
        _gsap.TweenMax.to(point9, speed, { attr: { x: 12, y: 12, height: 2 } });
    });
};

var initClickToScroll = function initClickToScroll() {
    var buttons = $('[data-clicktoscroll]');
    buttons.each(function (index, button) {
        var id = $(button).data('clicktoscroll');
        var target = $('#' + id);
...
},{"aos":8,"gsap":9}],3:[function(require,module,exports){
'use strict';
...
var _articleDetail = require('../pages/article-detail');
...
},{"../pages/article-detail":1,"../pages/common":2,"../pages/home":3}],5:[function(require,module,exports){
'use strict';
...
var injectEmailLink = function injectEmailLink(element) {
    var s = '@',
        n = 'hello',
...
exports.injectEmailLink = injectEmailLink;

},{}],7:[function(require,module,exports){
"use strict";

var _DomRouter = require("./lib/router/DomRouter.js");
...
(0, _jquery2.default)(function () {
  var domRouter = new _DomRouter2.default();
  domRouter.loadEvents();
});

},{"./lib/router/DomRouter.js":4,"jquery":10}],8:[function(require,module,exports){
